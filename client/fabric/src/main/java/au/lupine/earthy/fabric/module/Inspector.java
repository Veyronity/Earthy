...
public final class Inspector extends Module {
    ...
    private static final KeyMapping INSPECT_KEY = KeyBindingHelper.registerKeyBinding(
            new KeyMapping("key.earthy.inspect", InputConstants.Type.KEYSYM, GLFW.GLFW_KEY_G, KeyMapping.Category.register(Identifier.fromNamespaceAndPath("earthy", "category")))
    );
